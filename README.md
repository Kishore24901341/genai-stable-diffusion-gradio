...
demo = gr.Interface(fn=generate,
                    ...
                    examples=["A cat dressed up as arab in desert","a robot in Indian attire"])

demo.launch(share=True, server_port=int(os.environ['PORT1']))
```

### OUTPUT:
![EXP7](https://github.com/user-attachments/assets/896248ca-b676-416e-ae33-7bcba544c05e)
